/*******
 * This is the TextBasedApp class which was previously known as "Main.java", it has been renamed and rewored accordingly.
 */
...
public class TextBasedApp {
	...
	/****************
	 * public void start
	 * the method that boots up the text based application. Uses a scanner to 
	 * get user input and the console displays a menu or information accordingly.
	 * 
	 */
	public void start() {
	...
	/*******
	 * instantiateKeywords()
	 * This method is used in the TextBasedApp constructor to add keywords that are special to display information.
	 */
