...
public class GUIApp extends Application{
	...
	/*
	 * The main GUI that the user should run when starting the application. 
	 * 
	 * 
	 * 
	 * 
	...
	public void start(Stage primaryStage) throws Exception {
		...
		window = primaryStage;
		appBackground = new Image("/images/SpaceBackGround.jpg");	
		...
		/*******
		 * There will be a bunch of handlers for most of the buttons that exist in our
		 * program. Anything that starts with the name "back", has an event handler to return to the previous scene
		 * in our application. Anything with a unique name like "venus" ,"jupiter", or "sun" with "Button" next to it has
		 * an event handler that brings up a popup menu displaying the planet itself with code in a seperate class.
		 * 
		 * 
		 * 
		 */
		...
		venusButton.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent event) {
				VenusDisplay v = new VenusDisplay();
				v.display();
			}
		});
		...
		jupiterButton.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent event) {
				JupiterDisplay j = new JupiterDisplay();
				j.display();
			}
		});
	    ...
	    sunButton.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent event) {
				SunDisplay s = new SunDisplay();
				s.display();
			}
		});
	...
	/*******
	 * updateCurrentScene()
	 * Keeps track of the current scene in our application and updates the instance var currentScene to aScene.
	 * @param aScene
	 */
	...
	/*******
	 * updatePreviousScene()
	 * Keeps track of the previous scene in our application and updates the instance var previousScene to aScene.
	 * @param aScene
	 */
