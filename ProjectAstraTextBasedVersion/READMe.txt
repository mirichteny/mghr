...
(For text-based)(Updated as of 04/06/2020)
...
**For eclipse***
	...
	Create a new java project, and import the java files needed to run the program (stated above) to the src directory. Then right click on "TextBasedApp.java" and click " Run As -> Java Application". 
